    ...
    <Modal id="createServices" title="Add New Services" v-vb-is:modal :size="{defalut:'lg'}">
        <form @submit.prevent="createServices">
            <div class="modal-body">
                <div class="row mb-1">
                    <div class="col-md">
                        <label>Services Name: <Required/></label>
                        <div class="">
                            <input v-model="createForm.name" type="text" placeholder="Services Name" class="form-control">
                    ...
                    <div class="col-md">
                        ...
                        <div class="">
                            <input v-model="createForm.price" type="number" placeholder="Services Price" class="form-control">
                ...
                <div class="row mb-1">
                    <div class="col-md">
                        ...
                        <textarea v-model="createForm.description" type="text" placeholder="Services Full Description" rows="5" class="form-control"></textarea>
...
<script setup>
    ...
    let createServices = ( )=>{
        Inertia.post('services', createForm, {
            ...
            onSuccess: ()=> {
                document.getElementById('createServices').$vb.modal.hide()
                createForm.reset()
                Swal.fire(
                    'Saved!',
