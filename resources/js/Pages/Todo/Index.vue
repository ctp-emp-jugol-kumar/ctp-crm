                                ...
                                <div class="chat-fixed-search">
                                    <div class="d-flex align-items-center w-100">
                                        <div class="input-group input-group-merge ms-1 w-100">
                                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addTodo">Add Todo</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body chat-height p-0 border-end">
                                ...
                                <div class="sidebar-menu-list ps ">
                                    <div class="list-group list-group-filters">
                                        <a href="#" class="d-flex align-items-center list-group-item list-group-item-action border-0" @click="activeClass('important')" :class="activeClassRef === 'important' ? 'active-list' : ''">
                    ...
                    <div class="col-md-9 ms-0 ps-0  bg-white" id="mainSection">
                        <div  class="card h-100 shadow-none mb-0 pb-0 rounded-0">
                            ...
                            <div class="card-body chat-bg p-0 min-chat-height">
                                <ul id="chat">
                                    <li class="d-flex align-items-center justify-content-between todo-item-style p-1" v-for="i in 25">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div clas="d-flex">
                                                <p class="m-0 text-black">
                                                    {{ itemText.slice(0, 100) }}
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center gap-1">
                                                <span class="badge bg-info">update</span>
                                                    <span class="avatar me-1 ms-2">
                                                    <img src="/images/1.png" height="32" width="32" alt="Generic placeholder image">
                                                </span>
                                            </div>
                                        </div>
                                    </li>
            ...
            <div class="modal-content p-0">
                ...
                <div class="modal-body flex-grow-1">
                    <form @submit.prevent="saveTodo">
                        <div class="mb-1">
                            <label>Title</label>
                            <input id="balance" v-model="formData.title" class="form-control" type="text" placeholder="Todo Title"/>
                        </div>
                        ...
                        <div class="d-flex flex-wrap mb-0">
                            <button type="submit" class="btn btn-primary me-1" data-bs-dismiss="modal">Save Todo</button>
...
const activeClassRef=ref('myTask')
